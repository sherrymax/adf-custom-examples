...
export class AppLayoutComponent implements OnInit, OnDestroy {
    ...
    links: Array<any> = [
        ...
        //     ]
        // },
        { href: '/files', icon: 'folder_open', title: 'Contracts' },
        ...
        {
            href: '/search', icon: 'search', title: 'APP_LAYOUT.SEARCH', children: [
                { href: '/extendedSearch/', icon: 'search', title: 'Extended Search' },
                { href: '/kendraSearch', icon: 'search', title: 'AWS Kendra Search' }
            ]
        },
