...
import { ViewerRenderComponent } from '@alfresco/adf-core';
...
@NgModule({
    ...
    declarations: [FileViewComponent, AlfrescoEnterpriseViewerComponent],
    exports: [FileViewComponent, AlfrescoEnterpriseViewerComponent],
    providers: [ViewerRenderComponent]
})
