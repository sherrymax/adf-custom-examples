...
//    @Input() hideSidenav = false;
 ...
 //        this.SIDENAV_STATES.MOBILE = { value: 'compact', params: { width: this.sidenavMin } };

 //       this.SIDENAV_STATES.EXPANDED = { value: 'compact', params: { width: this.sidenavMin } };
          this.SIDENAV_STATES.COMPACT = { value: 'compact', params: { width: this.sidenavMin } };

        this.CONTENT_STATES.MOBILE = { value: 'expanded' };
//        this.CONTENT_STATES.MOBILE = { value: 'compact' };
